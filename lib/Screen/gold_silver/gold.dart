...
class _GoldScreenState extends State<GoldScreen> {
  ...
  void initState() {
    ...
    super.initState();
    widget.silverlist;
    price = widget.silverlist.goldprice.toString();
            ...
            children: [
              Padding(
                ...
                child: Column(
                  children: [
                    Text(
                      "Unlocking Today's Gold Prices with Maa Alankar Jewellers",
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                        "Gold prices are influenced by various factors, including global economic conditions, geopolitical events, and currency fluctuations. At Maa Alankar Jewellers, we understand the significance of staying current with these trends to provide you with the best possible value for your investments.")
                  ],
                ),
              ),
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                        "Welcome to Maa Alankar Jewellers, your trusted destination for exquisite jewelry. In today's blog, we delve into the ever-changing landscape of gold prices to help you make informed decisions and stay updated on the latest trends. Let's navigate through the currents of the gold market and discover the value of your precious metal today."),
                    Text(
                        "As of $date, the gold market reflects $price . At Maa Alankar Jewellers, we believe in transparency, and our commitment to fair pricing ensures that you get the most accurate reflection of the market value when you engage with us.")
                  ],
                ),
              ),
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                        "Without further ado, let's explore the current gold prices at Maa Alankar Jewellers. As of $date, the price per gram for  stands at $price. This information serves as a valuable reference for those considering purchasing jewelry or investing in gold."),
                    Text(
                        "It's essential to note that gold prices can fluctuate throughout the day based on market conditions. To get the most accurate and up-to-date information, we recommend contacting our dedicated team at Maa Alankar Jewellers or visiting our store for real-time pricing.")
                  ],
                ),
              ),
              Padding(
              ...
              Padding(
                ...
                child: Column(
                  children: [
                    ...
                    Text(
                        "In conclusion, navigating the world of gold prices requires staying informed and choosing a trusted partner. Maa Alankar Jewellers is your beacon in this journey, offering not only competitive prices but also an unparalleled commitment to excellence. Connect with us today to explore our collection and make the most of today's gold prices."),
                  ],
                ),
              ),
            ],
